...
def initialize_session_state():
    ...
    if "initialized" not in st.session_state:
        ...
        # Load actual settings if available
        if SYSTEM_AVAILABLE:
            try:
                ...
                st.session_state.settings.update(
                    {
                        ...
                        "base_quantity": settings.base_quantity,
                        "max_quantity": settings.max_quantity,
                        "cycle_interval": settings.cycle_interval,
                    }
                )
                st.session_state.portfolio["cash"] = settings.initial_cash
                st.session_state.portfolio["total_value"] = settings.initial_cash
